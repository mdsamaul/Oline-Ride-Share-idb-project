...
- Create Angular project with ng: `ng new oline-ride-share-idb-project.client --defaults --skip-install --skip-git `.
...
- Create project file (`oline-ride-share-idb-project.client.esproj`).
